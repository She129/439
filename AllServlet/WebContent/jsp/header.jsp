...
<script>
	$(function() {
		//向服务端CategoryServlet->getAllCats发起请求，服务端经过处理，
		//将所有分类以json格式的数据返回，获取到返回的所有分类绑定在页面的显示分类区域
		var url = "/AllServlet/CategoryServlet";
		var obj = {
			"method" : "findAllCats"
		};
		$
						...
						function(data) {
							...
							$
									.each(
											data,
											function(i, obj) {
												var li = "<li><a href='/AllServlet/ProductServlet?method=findProductByCidWithPage&num=1&cid="
														+ obj.cid
														+ "'>"
														+ obj.cname
														+ "</a></li>";
	...
	/* a href='/AllServlet/ProductServlet?mtthod=findProductByCidWithPage&cid="obj.cid+"' */
</script>
